      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <section className="space-y-6">
            <h1 className="text-3xl font-bold">Metoda płatności</h1>
          ...
          <section className="bg-white p-6 rounded-xl shadow-lg h-fit">
            ...
            <div className="space-y-4">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{OFFER_DETAILS.promoPrice} {OFFER_DETAILS.currency}</span>
              </div>
              
              <div className="flex justify-between text-gray-500">
                <span>Regularna cena</span>
                <span className="line-through">{OFFER_DETAILS.regularPrice} {OFFER_DETAILS.currency}</span>
              </div>

              <div className="flex justify-between text-green-600">
                <span>Oszczędzasz</span>
                <span>{OFFER_DETAILS.regularPrice - OFFER_DETAILS.promoPrice} {OFFER_DETAILS.currency}</span>
              </div>
              ...
              <div className="flex justify-between font-bold text-lg">
                ...
                <span>{OFFER_DETAILS.promoPrice} {OFFER_DETAILS.currency}</span>
              </div>
